          ...
          <tbody class="whitespace-nowrap">
            <tr class="odd:bg-blue-50">
              ...
              <td class="p-4 text-sm text-slate-600 font-medium">
                <span class="w-[68px] block text-center font-medium py-1 border border-green-500 text-green-600 rounded text-xs">
                  Active
                </span>
              </td>
              <td class="p-4 text-sm text-slate-600 font-medium">Bravo</td>
              <td class="p-4 text-sm text-slate-600 font-medium">8066</td>
              <td class="p-4 text-sm text-slate-600 font-medium">
              ...
              <td class="p-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-5 h-5 cursor-pointer fill-gray-500 rotate-90"
                  viewBox="0 0 24 24"
                >
            ...
            <tr class="odd:bg-blue-50">
              ...
              <td class="p-4 text-sm text-slate-900 font-medium">Mitsubishi</td>
              <td class="p-4 text-sm text-slate-600 font-medium">
                <span class="w-[68px] block text-center font-medium py-1 border border-yellow-500 text-yellow-600 rounded text-xs">
                  Pending
                </span>
              </td>
              <td class="p-4 text-sm text-slate-600 font-medium">Bravo</td>
              <td class="p-4 text-sm text-slate-600 font-medium">9055</td>
              <td class="p-4 text-sm text-slate-600 font-medium">
                <div class="flex items-center cursor-pointer">
                  <img
            ...
            <tr class="odd:bg-blue-50">
              ...
              <td class="p-4 text-sm text-slate-900 font-medium">IBM</td>
              <td class="p-4 text-sm text-slate-600 font-medium">
                <span class="w-[68px] block text-center font-medium py-1 border border-green-500 text-green-600 rounded text-xs">
                  Active
                </span>
              </td>
              <td class="p-4 text-sm text-slate-600 font-medium">Gold</td>
              <td class="p-4 text-sm text-slate-600 font-medium">7011</td>
              <td class="p-4 text-sm text-slate-600 font-medium">
                <div class="flex items-center cursor-pointer">
                  <img
            ...
            <tr class="odd:bg-blue-50">
              ...
              <td class="p-4 text-sm text-slate-900 font-medium">Starbucks</td>
              <td class="p-4 text-sm text-slate-600 font-medium">
                <span class="w-[68px] block text-center font-medium py-1 border border-yellow-500 text-yellow-600 rounded text-xs">
                  Pending
                </span>
              </td>
              <td class="p-4 text-sm text-slate-600 font-medium">Alfa</td>
              <td class="p-4 text-sm text-slate-600 font-medium">6605</td>
              <td class="p-4 text-sm text-slate-600 font-medium">
                <div class="flex items-center cursor-pointer">
                  <img
            ...
            <tr class="odd:bg-blue-50">
              ...
              <td class="p-4 text-sm text-slate-600 font-medium">Gold</td>
              <td class="p-4 text-sm text-slate-600 font-medium">9956</td>
              <td class="p-4 text-sm text-slate-600 font-medium">
                <div class="flex items-center cursor-pointer">
                  <img
